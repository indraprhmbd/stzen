-- 0031: link atomic-checkout orders back to their cart.
-- Lets payment failures/expiry restore the exact CHECKOUT_PENDING cart.
-- Legacy direct-checkout rows keep cart_id NULL.
...
-- Same signature as 0030; only change is orders.cart_id = p_cart_id.
