-- 0030: atomic cart checkout and credential reservation.
-- Service-role only. Function owns cart locking, price recomputation,
-- order-unit expansion, and credential reservation in one transaction.
