/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a86efc671f4b1342895752902cfbfe9a)
// Runtime types generated with workerd@1.20260903.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	ENV: "production" | "staging";
	CORS_ALLOWED_ORIGINS: "https://stzen.web.id" | "http://localhost:5173,http://localhost:4173,https://dev.stzen.web.id" | "http://localhost:5173,http://localhost:4173,https://collected-ankle-dynamic.ngrok-free.dev";
	ADMIN_APP_BASE_URL: "https://stzen.web.id" | "https://dev.stzen.web.id" | "";
	PAYMENT_SUMOPOD_METHOD_CODE: "QRIS";
	PAYMENT_DUITKU_BASE_URL: "";
	NOTIFY_PROVIDERS: "" | "gcal";
	DATABASE_URL: string;
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ADMIN_APP_BASE_URL: "https://stzen.web.id";
		PAYMENT_SUMOPOD_METHOD_CODE: "QRIS";
		PAYMENT_DUITKU_BASE_URL: "";
		NOTIFY_PROVIDERS: "";
		DATABASE_URL: string;
	...
	interface StagingEnv {
		...
		ADMIN_APP_BASE_URL: "https://dev.stzen.web.id";
		PAYMENT_SUMOPOD_METHOD_CODE: "QRIS";
		PAYMENT_DUITKU_BASE_URL: "";
		NOTIFY_PROVIDERS: "gcal";
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENV" | "CORS_ALLOWED_ORIGINS" | "ADMIN_APP_BASE_URL" | "PAYMENT_SUMOPOD_METHOD_CODE" | "PAYMENT_DUITKU_BASE_URL" | "NOTIFY_PROVIDERS" | "DATABASE_URL" | "DATABASE_DIRECT_URL" | "SUPABASE_URL" | "SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "AES_SECRET_KEY" | "PAYMENT_ACTIVE_PROVIDER" | "PAYMENT_APP_BASE_URL" | "PAYMENT_DEFAULT_EXPIRY_MINUTES" | "PAYMENT_SUMOPOD_CAPTURE" | "PAYMENT_SUMOPOD_API_KEY" | "PAYMENT_SUMOPOD_BASE_URL" | "PAYMENT_SUMOPOD_WEBHOOK_SECRET" | "PAYMENT_SUMOPOD_WEBHOOK_TOKEN">> {}
}
